...
export default function VideoCard({
  ...
  return (
    <div
      ref={containerRef}
      className="video-snap-item relative h-full w-full shrink-0 snap-start bg-black"
    >
      <video
        ref={ref}
        src={video.video_url}
      ...
      {playbackError && (
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-ink px-8 text-center">
      ...
      {/* Azioni (like/commenti/condividi) e testo video, entrambi ancorati in basso a destra */}
      <div className="absolute inset-x-0 bottom-0 flex flex-col items-end gap-4 bg-gradient-to-t from-black/85 via-black/25 to-transparent p-4 pb-6">
